...
public class NodeConnector : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < skillNodes.Length; i++)
        {
            ...
            if (connections.Count > 0)
            {
                ...
                {
                    Vector3 pos1 = skillNodes[i].gameObject.GetComponent<RectTransform>().localPosition;
                    Vector3 pos2 = connections[j].gameObject.GetComponent<RectTransform>().localPosition;
    ...
    private Connector CreateConnector(Vector3 pos1, Vector3 pos2)
    {
        ...
        connector.GetComponent<RectTransform>().localPosition = connectorPos;
